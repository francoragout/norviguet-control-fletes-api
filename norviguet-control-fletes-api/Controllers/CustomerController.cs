...
namespace norviguet_control_fletes_api.Controllers
{
    ...
    public class CustomerController(ICustomerService service) : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<CustomerDto>> UpdateCustomer(int id, [FromBody] CustomerUpdateDto dto, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status409Conflict)]
        public async Task<IActionResult> BulkDeleteCustomers([FromBody] int[] ids, CancellationToken cancellationToken)
        {
